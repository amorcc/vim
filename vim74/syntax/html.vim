...
syn match   htmlArg contained "v-on:Click"
syn match   htmlArg contained "v-if"
syn match   htmlArg contained "v-show"
syn match   htmlArg contained "v-for"
syn match   htmlArg contained "v-model"
syntax region htmlArg start=/{{/ end=/}}/ oneline
...
" syn keyword htmlEvent contained ready data
